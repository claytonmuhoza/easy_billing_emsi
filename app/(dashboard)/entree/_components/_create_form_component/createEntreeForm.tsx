import { entree_stock_action } from '@/actions/ebms/stock_mouvement'
import FormAlert from '@/app/(dashboard)/_components/FormAlert'
import { entree_stock_schema } from '@/schemas'
...
export default function CreateEntreeForm({
   ...
   const sendForm = (values: z.infer<typeof entree_stock_schema>) => {
      startTransition(() => {
