import { inventaire_stock_action } from '@/actions/ebms/stock_mouvement'
import FormAlert from '@/app/(dashboard)/_components/FormAlert'
import { inventaire_stock_schema } from '@/schemas'
...
export default function CreateInventaireForm({
   ...
   const sendForm = (values: z.infer<typeof inventaire_stock_schema>) => {
      startTransition(() => {
