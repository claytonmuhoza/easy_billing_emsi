...
export default function NormalPrint({
   ...
   return (
      <div className="flex w-full flex-col gap-2 p-8 text-xs text-black dark:text-white">
         ...
         <div>
            <Table className="border-collapse overflow-hidden border ">
               <Table.Head className="bg-white font-bold">
                  ...
                  <Table.HeadCell className="max-w-4 break-words border border-black bg-white p-0">
                     Quantité
                  </Table.HeadCell>
                  {facture.societe.tva ||
               ...
               <Table.Body className="divide-y">
                  ...
                  {facture && (
                     <>
                        ...
                        <Table.Row className="text-bold  border border-black bg-white dark:border-gray-700 dark:bg-gray-800">
                           <Table.Cell
                              aria-controls="facture"
                              aria-expanded
                              colSpan={2}
         ...
         <div>Signature OBR : {facture.numero_unique_facture}</div>
